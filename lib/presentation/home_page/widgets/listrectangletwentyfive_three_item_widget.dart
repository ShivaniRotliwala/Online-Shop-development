...
class ListrectangletwentyfiveThreeItemWidget extends StatelessWidget {
  ListrectangletwentyfiveThreeItemWidget(
      this.listrectangletwentyfiveThreeItemModelObj);

  ListrectangletwentyfiveThreeItemModel
      listrectangletwentyfiveThreeItemModelObj;
