...
class ListrectangletwentyfiveSixItemWidget extends StatelessWidget {
  ListrectangletwentyfiveSixItemWidget(
      this.listrectangletwentyfiveSixItemModelObj);

  ListrectangletwentyfiveSixItemModel listrectangletwentyfiveSixItemModelObj;
